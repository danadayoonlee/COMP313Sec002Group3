		...
		<div class="row">
			<div class="col-6">
				...
				<select class="form-select"
					name="diseaseId" th:field="*{DiseaseId}" disabled="disabled">
			...
			<div class="col-6">
				<label>Date Visited</label> <input type="date"
					class="form-control" name="dateVisited" value="${patientmedicalinfo.getDateVisited()}" disabled="disabled"/>
			</div>
		</div>
		...
		<div class="row">
			<div class="col">
				...
				<textarea class="form-control" rows="3" 
					id="reasonForVisit" name="reasonForVisit" disabled="disabled">${patientmedicalinfo.getReasonForVisit()}</textarea>
			</div>
		</div>
		<br />
		<div class="row">
			<div class="col">
				...
				<textarea class="form-control" rows="3" 
					id="problems" name="problems" disabled="disabled">${patientmedicalinfo.getProblems()}</textarea>
			</div>
		</div>
		<br />
		<div class="row">
			<div class="col">
				...
				<textarea class="form-control" rows="3" name="medications"
					  name="medications" disabled="disabled">${patientmedicalinfo.getMedications()}</textarea>
			</div>
		</div>
		<br />
		<div class="row">
			<div class="col">
				...
				<textarea class="form-control" rows="3" name="allergies" disabled="disabled">${patientmedicalinfo.getAllergies()}</textarea>
			</div>
		</div>
		<br />
		<div class="row">
			<div class="col">
				...
				<textarea class="form-control" rows="3" name="treatment" disabled="disabled">${patientmedicalinfo.getTreatment()}</textarea>
			</div>
		</div>
		<br />
		<div class="row">
			<div class="col">
				<label>Services Due</label><input type="text" class="form-control"
					 value="${patientmedicalinfo.getServicesDue()}" name="servicesDue" disabled="disabled"/>
			</div>
		</div>
		<br />
		<div class="row">
			<div class="col-6">
				<label>Location Of Visit</label> <select class="form-select"
					name="locationOfVisit" th:field="*{LocationOfVisit}" disabled="disabled">
			...
			<div class="col-6">
				<label>Next Follow-up</label> <input type="date"
					class="form-control" name="followUp" value="${patientmedicalinfo.getFollowUp()}" disabled="disabled" />
			</div>
		</div>
		<br />
